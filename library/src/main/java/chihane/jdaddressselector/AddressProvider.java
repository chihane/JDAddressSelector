...
public interface AddressProvider {
    ...
    void provideCountiesWith(int countyId, AddressReceiver<County> addressReceiver);
    void provideStreetsWith(int streetId, AddressReceiver<Street> addressReceiver);
